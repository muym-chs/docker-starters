...
class DefaultContentEntitySettingsForm extends FormBase {
  ...
  /**
   * Defines the settings form for Default content entity entities.
   *
   * @param array $form
   *   An associative array containing the structure of the form.
   * @param \Drupal\Core\Form\FormStateInterface $form_state
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $form['defaultcontententity_settings']['#markup'] = 'Settings form for Default content entity entities. Manage field settings here.';
    return $form;
  }
