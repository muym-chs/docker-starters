 ...
 * @code
 * dcg_module_mix.uid_parameter_converter:
 *   path: example/{record}
 *   defaults:
 *     _controller: '\Drupal\dcg_module_mix\Controller\DcgModuleMixController::build'
 *   requirements:
 *     _access: 'TRUE'
 *   options:
 *     parameters:
 ...
 */
class UidParamConverter implements ParamConverterInterface {
  ...
  /**
   * Constructs a new UidParamConverter.
   *
  ...
  public function applies($definition, $name, Route $route) {
    return !empty($definition['type']) && $definition['type'] == 'uid';
  }
