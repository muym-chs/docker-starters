...
namespace Drupal\dcg_module_mix\Plugin\Condition;
...
/**
 * Provides a 'DcgCustomCondition' condition.
 *
 * @Condition(
 *   id = "dcg_module_mix_dcgcustomcondition",
 *   label = @Translation("DcgCustomCondition"),
 *   context_definitions = {
 ...
 */
class Dcgcustomcondition extends ConditionPluginBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Creates a new Dcgcustomcondition instance.
   *
