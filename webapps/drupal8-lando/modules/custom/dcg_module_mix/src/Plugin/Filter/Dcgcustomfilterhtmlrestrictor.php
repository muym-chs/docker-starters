...
/**
 * Provides a 'DcgCustomFilterHtmlRestrictor' filter.
 *
 * @Filter(
 *   id = "dcg_module_mix_dcgcustomfilterhtmlrestrictor",
 *   title = @Translation("DcgCustomFilterHtmlRestrictor"),
 ...
 * )
 */
class Dcgcustomfilterhtmlrestrictor extends FilterBase {
