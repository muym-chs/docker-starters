...
/**
 * Provides a 'DcgCustomFilterReversibleTransformation' filter.
 *
 * @Filter(
 *   id = "dcg_module_mix_dcgcustomfilterreversibletransformation",
 *   title = @Translation("DcgCustomFilterReversibleTransformation"),
 ...
 * )
 */
class Dcgcustomfilterreversibletransformation extends FilterBase {
